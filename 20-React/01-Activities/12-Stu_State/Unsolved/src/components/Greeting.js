...
function Greeting() {
  ...
  // let greeting = 'Welcome the following students to class!';useState('Welcome the following students to class!');
  ...
  const [group,setGroup] = ['Student 1', 'Student 2', 'Student 3'];
